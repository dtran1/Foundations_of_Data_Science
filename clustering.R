...
wssplot(wine)
#bend occurs at 2-3 clusters 

# Exercise 2:
#   * How many clusters does this method suggest? 2-3 clusters 
...
k = 3 
#make kmeans model
fit.km = kmeans(wine, centers = k, iter.max=1000)
...
wine$Type
table(wine$Type)
#fairly close to the wine$Type so I would say yes. 
